...
ar.push("<tr><th>Id</th><th>Canonical url / Observable entity url</th><th>Type</th><th>Description</th></tr>")
...
//console.log(link)
                        ...
                        if (profile.type == 'Observation') {
                            ...
                            //ar.push(`<td>${cleanText(profile.description)}<br/>`)
                        ...
                        if (profile.type == 'Observation') {
                            ...
                            ar.push(`<td>${cleanText(profile.description)}<br/>`)
                            arSlices.forEach(function(slice){
                                ar.push(`<strong>${slice.system} : ${slice.code} </strong><br/>`)
                            })
                            ar.push('</td>')
                        } else {
...
function getSlices(Observation) {
    let arSlices = []
    if (Observation.differential && Observation.differential.element) {
        //create a hash based on id
        let hash = {}
        Observation.differential.element.forEach(function(element){
